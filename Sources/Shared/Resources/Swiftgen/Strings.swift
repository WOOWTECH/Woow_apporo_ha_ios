...
public enum L10n {
  ...
  public enum Alerts {
    public enum ActionAutomationEditor {
      public enum Unavailable {
        /// To automatically create an automation for an Action please update your Apporo aiot to at least version 2024.2
        public static var body: String { return L10n.tr("Localizable", "alerts.action_automation_editor.unavailable.body") }
        /// Please update Apporo aiot
    ...
    public enum NavigationError {
      /// This page cannot be displayed because it's outside your Apporo aiot server or the page was not found.
  ...
  public enum AppIntents {
    ...
    public enum PerformAction {
      ...
      /// Perform an action on a Apporo aiot server
    ...
    public enum RenderTemplate {
      /// Render a Apporo aiot template. Only users with the admin role can perform this action.
    ...
    public enum UpdateLocation {
      /// Send a location update to Apporo aiot
    ...
    public enum UpdateSensors {
      /// Send a sensor update to Apporo aiot
  ...
  public enum Assist {
    ...
    public enum Carplay {
      public enum PlaybackHelp {
        /// If you encounter audio playback issues, open CarPlay settings in the Apporo aiot app, tap Advanced, open Assist, and change TTS Playback to Download and play.
        ...
        public enum OpenApp {
          /// Open CarPlay settings in the Apporo aiot app.
  ...
  public enum CameraList {
    ...
    public enum Empty {
      /// No camera entities found in your Apporo aiot setup
  ...
  public enum CameraPlayer {
    public enum Errors {
      ...
      /// Unable to connect to Apporo aiot
  ...
  public enum CarPlay {
    ...
    public enum QuickAccess {
      public enum AddItem {
        ...
        public enum AssistPrompt {
          /// Assist prompts can only be created in the Apporo aiot app on your iPhone.
          public static var message: String { return L10n.tr("Localizable", "carPlay.quick_access.add_item.assist_prompt.message") }
        }
        public enum Confirmation {
          /// For more customization, configure Quick Access in the Apporo aiot app on your iPhone.
  ...
  public enum Connection {
    public enum Error {
      ...
      public enum FailedConnect {
        ...
        /// We couldn't connect to Apporo aiot
    ...
    public enum Permission {
      public enum InternalUrl {
        /// To access Apporo aiot locally in a secure way, you need to grant the location permission ('Always').
        public static var body1: String { return L10n.tr("Localizable", "connection.permission.internal_url.body1") }
        /// This permission allows Apporo aiot to detect the wireless network that you're connected to and establish a local connection.
  ...
  public enum DeviceName {
    /// This is used to identify your device in your Apporo aiot.
  ...
  public enum Gestures {
    ...
    public enum Screen {
      /// Gestures below will be applied whenever you are using Apporo aiot main UI.
  ...
  public enum HaApi {
    public enum ApiError {
      ...
      /// Received invalid response from Apporo aiot
      ...
      /// The mobile_app component is not loaded. Please add it to your configuration, restart Apporo aiot, and try again.
      ...
      /// Your Apporo aiot version (%@) is too old, you must upgrade to at least version %@ to use the app.
  ...
  public enum Kiosk {
    ...
    public enum Sensors {
      /// Report kiosk mode, brightness, and volume to Apporo aiot.
  ...
  public enum LegacyActions {
    /// Legacy iOS Actions are not the recommended way to interact with Apporo aiot anymore, please use Scripts, Scenes and Automations directly in your Widgets, Apple Watch and CarPlay.
  ...
  public enum LiveActivity {
    ...
    /// Real-time Apporo aiot updates on your Lock Screen and Dynamic Island.
    ...
    public enum FrequentUpdates {
      /// Allows Apporo aiot to update Live Activities up to once per second. Enable in Settings u203A %@ u203A Live Activities.
    ...
    public enum Sync {
      ...
      /// Reports running Live Activities to Apporo aiot and releases tokens for any that have ended. Runs automatically when the app opens.
    ...
    public enum ItemType {
      public enum Action {
        public enum List {
          ...
          public enum Warning {
            /// We will stop supporting iOS Actions in the future, please consider using Apporo aiot scripts or scenes instead.
  ...
  public enum Nfc {
    ...
    public enum List {
      ...
      /// 
      /// Tags will work on any device with Apporo aiot installed which has hardware support to read them.
    ...
    public enum Read {
      ...
      public enum Error {
        ...
        /// NFC tag is not a Apporo aiot tag
    ...
    public enum TagApproval {
      ...
      /// Send this tag to Apporo aiot to trigger linked automations.
    ...
    public enum Action {
      ...
      public enum Rows {
        public enum AuthenticationRequired {
          /// When the user selects an action with this option, the system prompts the user to unlock the device. After unlocking, Apporo aiot will be notified of the selected action.
  ...
  public enum Onboarding {
    ...
    public enum LocalAccess {
      /// If this app knows when you’re away from home, it can choose a more secure way to connect to your Apporo aiot system. This requires location services to be enabled.
      ...
      /// This data will never be shared with the Apporo aiot project or third parties.
    ...
    public enum LocalOnlyDisclaimer {
      /// Your Apporo aiot is only accessible on your home network. To control your smart home from anywhere, you can set up remote access later in your settings.
    ...
    public enum LocationAccess {
      /// Location sharing enables powerful automations, such as turning off the heating when you leave home. This option shares the device’s location only with your Apporo aiot system.
      public static var primaryDescription: String { return L10n.tr("Localizable", "onboarding.location_access.primary_description") }
      /// This data stays in your home and is never sent to third parties. It also helps strengthen the security of your connection to Apporo aiot.
    ...
    public enum ManualSetup {
      ...
      /// The URL of your Apporo aiot server. Make sure it includes the protocol and port.
    ...
    public enum ManualUrlEntry {
      /// What is your Apporo aiot address?
    ...
    public enum NetworkInput {
      /// For the best experience, Apporo aiot needs to know when you’re connected to your home network.
      ...
      public enum NoNetwork {
        ...
        public enum Skip {
          public enum Alert {
            /// You haven't set a home network. You can set it up later in the app settings, until that we will only use your remote connection (if it exists) to access Apporo aiot.
    ...
    public enum Permission {
      public enum Location {
        /// To identify if you are at home and connect locally to Apporo aiot, Apple requires that we ask for your location permission.
        public static var description: String { return L10n.tr("Localizable", "onboarding.permission.location.description") }
        public enum Deny {
          public enum Alert {
            /// If you are sure, please continue and tap 'Deny' on the next popup as well, in case you don't have a remote connection configured, the App will use your local connection configuration to access Apporo aiot.
    ...
    public enum Permissions {
      ...
      public enum Focus {
        /// Allow whether you are in focus mode to be sent to Apporo aiot
      ...
      public enum Motion {
        /// Allow motion activity and pedometer data to be sent to Apporo aiot
      ...
      public enum Notification {
        /// Allow push notifications to be sent from your Apporo aiot
    ...
    public enum Servers {
      ...
      public enum Search {
        ...
        public enum Loader {
          /// Check that your Apporo aiot is powered on and you're connected to the same network. You can enter the address manually if you know it.
  ...
  public enum Permission {
    ...
    public enum Screen {
      public enum Bluetooth {
        ...
        /// The Apporo aiot app can find devices using Bluetooth of this device. Allow Bluetooth access for the Apporo aiot app.
  ...
  public enum Settings {
    ...
    public enum ConnectionSection {
      ...
      /// Directly connect to the Apporo aiot server for push notifications when on internal SSIDs.
      ...
      public enum ClientCertificate {
        ...
        /// Import a PKCS#12 (.p12) certificate for mutual TLS authentication. Required when your Apporo aiot server requires client certificates.
    ...
    public enum Debugging {
      ...
      public enum Thread {
        /// Check what Thread credentials are inside Apple Keychain, you can also import in Apporo aiot or delete from Keychain.
    ...
    public enum MacToolbar {
      ...
      public enum HowToAdd {
        /// To add an entity, open its more info dialog in Apporo aiot, select the "Add to" button, then choose "Mac Toolbar".
    ...
    public enum ResetSection {
      public enum ResetAlert {
        /// Your settings will be reset and this device will be unregistered from push notifications as well as removed from your Apporo aiot configuration.
  ...
  public enum SettingsDetails {
    ...
    public enum General {
      ...
      public enum EdgeToEdge {
        /// Display Apporo aiot UI from edge to edge on devices that support it. This is an experimental feature which can be removed at any time and also may cause layout issues.
    ...
    public enum MacOpenInBrowser {
      /// Opens Apporo aiot in your default browser instead of the in-app web view, while keeping native features such as widgets working.
      public static var footer: String { return L10n.tr("Localizable", "settings_details.mac_open_in_browser.footer") }
      /// Open Apporo aiot UI in browser
    ...
    public enum Privacy {
      ...
      public enum Analytics {
        /// Allows collection of basic information about your device and interactions with the app. No user identifiable data is shared, including your Apporo aiot URLs and tokens. You must restart the app for changes to this setting to take effect.
  ...
  public enum SettingsSensors {
    /// Decide which of your device sensors you want to share with Apporo aiot.
  ...
  public enum Tags {
    ...
    public enum Allowed {
      ...
      /// Allowed tags can be sent to Apporo aiot without asking for approval each time. Swipe left on a tag to delete it.
  ...
  public enum Watch {
    ...
    public enum Settings {
      ...
      /// No servers synced yet. Open Apporo aiot on your paired iPhone, then refresh from the Home screen.
      ...
      public enum ClientCertificate {
        ...
        /// Open Apporo aiot on your iPhone to import the certificate, then refresh here.
      ...
      public enum PerformAction {
        ...
        /// Where actions run. Auto uses your iPhone when it's nearby, otherwise the Apple Watch connects directly to Apporo aiot.
  ...
  public enum WebView {
    ...
    public enum EmptyState {
      /// Please check your connection or try again later. If Apporo aiot is restarting it will reconnect after it is back online.
    ...
    public enum NoUrlAvailable {
      ...
      /// We can't connect to Apporo aiot
  ...
  public enum Widgets {
    ...
    public enum Custom {
      ...
      public enum ServerUnreachable {
        /// Apporo aiot could not be reached, please check your app server settings and connection security level.
        public static var body: String { return L10n.tr("Localizable", "widgets.custom.server_unreachable.body") }
        /// Apporo aiot could not be reached
    ...
    public enum Details {
      /// Display states using from Apporo aiot in text
      public static var description: String { return L10n.tr("Localizable", "widgets.details.description") }
      /// Display states using from Apporo aiot in text. ATTENTION: User needs to be admin for templating access
    ...
    public enum Gauge {
      /// Display numeric states from Apporo aiot in a gauge
      public static var description: String { return L10n.tr("Localizable", "widgets.gauge.description") }
      /// Display numeric states from Apporo aiot in a gauge. ATTENTION: User needs to be admin for templating access
    ...
    public enum OpenPage {
      /// Open a frontend page in Apporo aiot.
