...
public enum L10n {
  ...
  public enum Alerts {
    public enum ActionAutomationEditor {
      public enum Unavailable {
        /// To automatically create an automation for an Action please update your Apporo SmartHome to at least version 2024.2
        public static var body: String { return L10n.tr("Localizable", "alerts.action_automation_editor.unavailable.body") }
        /// Please update Apporo SmartHome
    ...
    public enum NavigationError {
      /// This page cannot be displayed because it's outside your Apporo SmartHome server or the page was not found.
  ...
  public enum AppIntents {
    ...
    public enum PerformAction {
      ...
      /// Perform an action on a Apporo SmartHome server
    ...
    public enum RenderTemplate {
      /// Render a Apporo SmartHome template. Only users with the admin role can perform this action.
    ...
    public enum UpdateLocation {
      /// Send a location update to Apporo SmartHome
    ...
    public enum UpdateSensors {
      /// Send a sensor update to Apporo SmartHome
  ...
  public enum Assist {
    ...
    public enum Carplay {
      public enum PlaybackHelp {
        /// If you encounter audio playback issues, open CarPlay settings in the Apporo SmartHome app, tap Advanced, open Assist, and change TTS Playback to Download and play.
        ...
        public enum OpenApp {
          /// Open CarPlay settings in the Apporo SmartHome app.
  ...
  public enum CameraList {
    ...
    public enum Empty {
      /// No camera entities found in your Apporo SmartHome setup
  ...
  public enum CameraPlayer {
    public enum Errors {
      ...
      /// Unable to connect to Apporo SmartHome
  ...
  public enum CarPlay {
    ...
    public enum QuickAccess {
      public enum AddItem {
        ...
        public enum AssistPrompt {
          /// Assist prompts can only be created in the Apporo SmartHome app on your iPhone.
          public static var message: String { return L10n.tr("Localizable", "carPlay.quick_access.add_item.assist_prompt.message") }
        }
        public enum Confirmation {
          /// For more customization, configure Quick Access in the Apporo SmartHome app on your iPhone.
  ...
  public enum Connection {
    public enum Error {
      ...
      public enum FailedConnect {
        ...
        /// We couldn't connect to Apporo SmartHome
        ...
        public enum CloudInactive {
          /// You have disabled Apporo SmartHome Cloud use in the app, if you need it for remote access please open companion app settings and enable it.
    ...
    public enum Permission {
      public enum InternalUrl {
        /// To access Apporo SmartHome locally in a secure way, you need to grant the location permission ('Always').
        public static var body1: String { return L10n.tr("Localizable", "connection.permission.internal_url.body1") }
        /// This permission allows Apporo SmartHome to detect the wireless network that you're connected to and establish a local connection.
  ...
  public enum DatabaseUpdater {
    public enum Toast {
      ...
      /// Updating %@
      public static func title(_ p1: Any) -> String {
        return L10n.tr("Localizable", "database_updater.toast.title", String(describing: p1))
      }
    }
  }
  ...
  public enum DeviceName {
    /// This is used to identify your device in your Apporo SmartHome.
  ...
  public enum Gestures {
    ...
    public enum Screen {
      /// Gestures below will be applied whenever you are using Apporo SmartHome main UI.
  ...
  public enum HaApi {
    public enum ApiError {
      ...
      /// Received invalid response from Apporo SmartHome
      ...
      /// The mobile_app component is not loaded. Please add it to your configuration, restart Apporo SmartHome, and try again.
      ...
      /// Your Apporo SmartHome version (%@) is too old, you must upgrade to at least version %@ to use the app.
  ...
  public enum Kiosk {
    ...
    public enum AutoReload {
      ...
      public static var subtitle: String { return L10n.tr("Localizable", "kiosk.auto_reload.subtitle") }
      /// Auto reload
      public static var title: String { return L10n.tr("Localizable", "kiosk.auto_reload.title") }
    }
    ...
    public enum Display {
      ...
      /// Default
      public static var dashboardDefault: String { return L10n.tr("Localizable", "kiosk.display.dashboard_default") }
      /// The chosen server and dashboard will be the ones displayed when the app opens.
      public static var footer: String { return L10n.tr("Localizable", "kiosk.display.footer") }
      /// Server
      public static var server: String { return L10n.tr("Localizable", "kiosk.display.server") }
      /// Display
    ...
    public enum Screensaver {
      ...
      /// Show seconds
      public static var showSeconds: String { return L10n.tr("Localizable", "kiosk.screensaver.show_seconds") }
      /// Time to start
      public static var timeToStart: String { return L10n.tr("Localizable", "kiosk.screensaver.time_to_start") }
      /// Timeout
      ...
      public enum ClockStyle {
        ...
        /// Medium
        public static var medium: String { return L10n.tr("Localizable", "kiosk.screensaver.clock_style.medium") }
        /// Small
        public static var small: String { return L10n.tr("Localizable", "kiosk.screensaver.clock_style.small") }
        /// Clock style
        public static var title: String { return L10n.tr("Localizable", "kiosk.screensaver.clock_style.title") }
      }
      ...
      public enum Timeout {
        ...
        /// 1 minute
        public static var minutes1: String { return L10n.tr("Localizable", "kiosk.screensaver.timeout.minutes_1") }
        /// 10 minutes
        public static var minutes10: String { return L10n.tr("Localizable", "kiosk.screensaver.timeout.minutes_10") }
        /// 15 minutes
        public static var minutes15: String { return L10n.tr("Localizable", "kiosk.screensaver.timeout.minutes_15") }
        /// 30 minutes
    ...
    public enum Sensors {
      /// Report kiosk mode, brightness, and volume to Apporo SmartHome.
  ...
  public enum LegacyActions {
    /// Legacy iOS Actions are not the recommended way to interact with Apporo SmartHome anymore, please use Scripts, Scenes and Automations directly in your Widgets, Apple Watch and CarPlay.
  ...
  public enum LiveActivity {
    ...
    /// Real-time Apporo SmartHome updates on your Lock Screen and Dynamic Island.
    ...
    public enum FrequentUpdates {
      /// Allows Apporo SmartHome to update Live Activities up to once per second. Enable in Settings u203A %@ u203A Live Activities.
    ...
    public enum Sync {
      ...
      /// Reports running Live Activities to Apporo SmartHome and releases tokens for any that have ended. Runs automatically when the app opens.
    ...
    public enum ItemType {
      public enum Action {
        public enum List {
          ...
          public enum Warning {
            /// We will stop supporting iOS Actions in the future, please consider using Apporo SmartHome scripts or scenes instead.
  ...
  public enum Nfc {
    ...
    public enum List {
      ...
      /// 
      /// Tags will work on any device with Apporo SmartHome installed which has hardware support to read them.
    ...
    public enum Read {
      ...
      public enum Error {
        ...
        /// NFC tag is not a Apporo SmartHome tag
    ...
    public enum TagApproval {
      ...
      /// Send this tag to Apporo SmartHome to trigger linked automations.
    ...
    public enum Action {
      ...
      public enum Rows {
        public enum AuthenticationRequired {
          /// When the user selects an action with this option, the system prompts the user to unlock the device. After unlocking, Apporo SmartHome will be notified of the selected action.
  ...
  public enum Onboarding {
    ...
    public enum Invitation {
      ...
      /// Apporo SmartHome address
      public static var addressTitle: String { return L10n.tr("Localizable", "onboarding.invitation.address_title") }
      /// Apporo SmartHome is open source home automation that puts local control and privacy first.
      ...
      /// Apporo SmartHome Invite
      public static var title: String { return L10n.tr("Localizable", "onboarding.invitation.title") }
    }
    public enum LocalAccess {
      /// If this app knows when you’re away from home, it can choose a more secure way to connect to your Apporo SmartHome system. This requires location services to be enabled.
      ...
      /// This data will never be shared with the Apporo SmartHome project or third parties.
    ...
    public enum LocalOnlyDisclaimer {
      /// Your Apporo SmartHome is only accessible on your home network. To control your smart home from anywhere, you can set up remote access later in your settings.
    ...
    public enum LocationAccess {
      /// Location sharing enables powerful automations, such as turning off the heating when you leave home. This option shares the device’s location only with your Apporo SmartHome system.
      public static var primaryDescription: String { return L10n.tr("Localizable", "onboarding.location_access.primary_description") }
      /// This data stays in your home and is never sent to third parties. It also helps strengthen the security of your connection to Apporo SmartHome.
    ...
    public enum ManualSetup {
      ...
      /// The URL of your Apporo SmartHome server. Make sure it includes the protocol and port.
    ...
    public enum ManualUrlEntry {
      /// What is your Apporo SmartHome address?
    ...
    public enum NetworkInput {
      /// For the best experience, Apporo SmartHome needs to know when you’re connected to your home network.
      ...
      public enum NoNetwork {
        ...
        public enum Skip {
          public enum Alert {
            /// You haven't set a home network. You can set it up later in the app settings, until that we will only use your remote connection (if it exists) to access Apporo SmartHome.
    ...
    public enum Permission {
      public enum Location {
        /// To identify if you are at home and connect locally to Apporo SmartHome, Apple requires that we ask for your location permission.
        public static var description: String { return L10n.tr("Localizable", "onboarding.permission.location.description") }
        public enum Deny {
          public enum Alert {
            /// If you are sure, please continue and tap 'Deny' on the next popup as well, in case you don't have a remote connection configured, the App will use your local connection configuration to access Apporo SmartHome.
    ...
    public enum Permissions {
      ...
      public enum Focus {
        /// Allow whether you are in focus mode to be sent to Apporo SmartHome
      ...
      public enum Motion {
        /// Allow motion activity and pedometer data to be sent to Apporo SmartHome
      ...
      public enum Notification {
        /// Allow push notifications to be sent from your Apporo SmartHome
    ...
    public enum Servers {
      ...
      public enum Search {
        ...
        public enum Loader {
          /// Check that your Apporo SmartHome is powered on and you're connected to the same network. You can enter the address manually if you know it.
          public static var text: String { return L10n.tr("Localizable", "onboarding.servers.search.loader.text") }
        }
      }
    }
    public enum Welcome {
      /// Allows you to access your Apporo SmartHome installation on the go. It runs locally in your home via a device like the Apporo SmartHome Green or Raspberry Pi.
      public static var body: String { return L10n.tr("Localizable", "onboarding.welcome.body") }
      /// This app connects to your Apporo SmartHome server and allows integrating data about you and your phone.
      /// 
      /// Apporo SmartHome is free and open source home automation software with a focus on local control and privacy.
      public static var description: String { return L10n.tr("Localizable", "onboarding.welcome.description") }
      /// Apporo SmartHome App
      ...
      /// Connect to my Apporo SmartHome
  ...
  public enum Permission {
    ...
    public enum Screen {
      public enum Bluetooth {
        ...
        /// The Apporo SmartHome app can find devices using Bluetooth of this device. Allow Bluetooth access for the Apporo SmartHome app.
  ...
  public enum Settings {
    ...
    public enum ConnectionSection {
      ...
      /// Directly connect to the Apporo SmartHome server for push notifications when on internal SSIDs.
      ...
      public enum ClientCertificate {
        ...
        /// Import a PKCS#12 (.p12) certificate for mutual TLS authentication. Required when your Apporo SmartHome server requires client certificates.
    ...
    public enum Debugging {
      ...
      public enum Thread {
        /// Check what Thread credentials are inside Apple Keychain, you can also import in Apporo SmartHome or delete from Keychain.
    ...
    public enum MacToolbar {
      ...
      public enum HowToAdd {
        /// To add an entity, open its more info dialog in Apporo SmartHome, select the "Add to" button, then choose "Mac Toolbar".
    ...
    public enum ResetSection {
      public enum ResetAlert {
        /// Your settings will be reset and this device will be unregistered from push notifications as well as removed from your Apporo SmartHome configuration.
  ...
  public enum SettingsDetails {
    ...
    public enum General {
      ...
      public enum EdgeToEdge {
        /// Display Apporo SmartHome UI from edge to edge on devices that support it. This is an experimental feature which can be removed at any time and also may cause layout issues.
    ...
    public enum MacOpenInBrowser {
      /// Opens Apporo SmartHome in your default browser instead of the in-app web view, while keeping native features such as widgets working.
      public static var footer: String { return L10n.tr("Localizable", "settings_details.mac_open_in_browser.footer") }
      /// Open Apporo SmartHome UI in browser
    ...
    public enum Privacy {
      ...
      public enum Analytics {
        /// Allows collection of basic information about your device and interactions with the app. No user identifiable data is shared, including your Apporo SmartHome URLs and tokens. You must restart the app for changes to this setting to take effect.
  ...
  public enum SettingsSensors {
    /// Decide which of your device sensors you want to share with Apporo SmartHome.
  ...
  public enum Tags {
    ...
    public enum Allowed {
      ...
      /// Allowed tags can be sent to Apporo SmartHome without asking for approval each time. Swipe left on a tag to delete it.
  ...
  public enum Watch {
    ...
    public enum Settings {
      ...
      /// No servers synced yet. Open Apporo SmartHome on your paired iPhone, then refresh from the Home screen.
      ...
      public enum ClientCertificate {
        ...
        /// Open Apporo SmartHome on your iPhone to import the certificate, then refresh here.
      ...
      public enum PerformAction {
        ...
        /// Where actions run. Auto uses your iPhone when it's nearby, otherwise the Apple Watch connects directly to Apporo SmartHome.
  ...
  public enum WebView {
    ...
    public enum EmptyState {
      /// Please check your connection or try again later. If Apporo SmartHome is restarting it will reconnect after it is back online.
    ...
    public enum NoUrlAvailable {
      ...
      /// We can't connect to Apporo SmartHome
  ...
  public enum Widgets {
    ...
    public enum Actions {
      /// Perform Apporo SmartHome actions.
    ...
    public enum CommonlyUsedEntities {
      ...
      public enum Empty {
        /// No commonly used entities found. Use Apporo SmartHome to build your usage history.
        public static var description: String { return L10n.tr("Localizable", "widgets.commonly_used_entities.empty.description") }
      }
    }
    public enum Controls {
      public enum Assist {
        /// Open Assist in Apporo SmartHome app
    ...
    public enum Custom {
      ...
      public enum ServerUnreachable {
        /// Apporo SmartHome could not be reached, please check your app server settings and connection security level.
        public static var body: String { return L10n.tr("Localizable", "widgets.custom.server_unreachable.body") }
        /// Apporo SmartHome could not be reached
    ...
    public enum Details {
      /// Display states using from Apporo SmartHome in text
      public static var description: String { return L10n.tr("Localizable", "widgets.details.description") }
      /// Display states using from Apporo SmartHome in text. ATTENTION: User needs to be admin for templating access
    ...
    public enum Gauge {
      /// Display numeric states from Apporo SmartHome in a gauge
      public static var description: String { return L10n.tr("Localizable", "widgets.gauge.description") }
      /// Display numeric states from Apporo SmartHome in a gauge. ATTENTION: User needs to be admin for templating access
    ...
    public enum OpenPage {
      /// Open a frontend page in Apporo SmartHome.
